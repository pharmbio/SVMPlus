...
svmFileName = "nr-ahr_nosalt.sdf.std_nodupl_class.sdf_descriptors.csv"

svmPlusFileName = "nr-ahr_nosalt.sdf.std_nodupl_class.sdf_SVMLIGHT_UNHASHED_radius_3.csv"

# Tuned values: 10, .01 : .915, 1, .01:914, 100,.01:915, 1000,.01,915
#
# tuned C and gamma kernel parameters
tunedSVMParam = [100, .001]  # [10, .01]
tunedSVMStarParam = [10, .01] #[1000,.01]
